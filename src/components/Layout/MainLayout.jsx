...
const handleLogout = () => {
  ...
  return (
    <>
<Backdrop open={loadingLogout} sx={{ color: "#fff", zIndex: 9999 }}>
  <div className="flex flex-col items-center">
    <CircularProgress size={64} thickness={4} />
    <span className="mt-4 text-lg font-semibold tracking-wider">
      LOGGING OUT...
    </span>
  </div>
</Backdrop>
  ...
  className={`cursor-pointer ${
    loadingLogout ? "pointer-events-none opacity-50" : ""
  }`}
>
