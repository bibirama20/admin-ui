    ...
    <>
      <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 ">
        {courses.map((course, index) => (
          <div key={index} className="shadow rounded-lg overflow-hidden flex flex-col hover:border border-gray-500 hover:shadow-lg hover:scale-105 transition-transform duration-300 ">
